...
with open('john.json', 'w', encoding='utf8') as file_obj:
    file_obj.writelines(json_dict2)
...
data =[]
#with open('animals.csv', 'w', newline='') as csv_file:
#    fieldnames = ['id', 'name']
#    csv_writer = csv.writer( csv_file,  delimiter=',')
#    for  item  in  data:
#        csv_writer.writerow([item[0], item[1]])
#    csv_writer.writerow({'4', 'bear'})

with open(csv_name, 'r') as f_object:
    animals = csv.reader(f_object, delimiter=',')
    for row in animals:
        data.append(row)
print("data is")
print(data)

#with open('animals2.csv', 'w', newline='') as csv_file:
#    fieldnames = ['id', 'name']
#    csv_writer = csv.writer( csv_file,  delimiter=',')
...
#with open('animals2.csv', 'r') as f_object:
#    reader = csv.reader(f_object, delimiter=',')
#    for row in reader:
#        data.append(row)
#    print(data)
